...
// function getInventory(idNum,searchTerm) {
//   inventory.forEach(){
//     if (inventory.id === idNum){
...
// }
// tyring novshiel's code, looks simpler
...
let oldCars = years.filter(year => year < 2000);
...
console.log(JSON.stringify(BMWAndAudi, null, 4));
